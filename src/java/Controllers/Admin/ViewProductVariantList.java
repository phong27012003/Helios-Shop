...
@WebServlet(name = "ViewProductVariantList", urlPatterns = {"/viewProductVariantList"})
public class ViewProductVariantList extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (user == null) {
            ...
            request.setAttribute("productvariants", productvariantList);
            request.setAttribute("currentPage", page);
            request.setAttribute("search", searchKeyword);
            request.getRequestDispatcher("Views/Admin/AdminListProductVariant.jsp").forward(request, response);

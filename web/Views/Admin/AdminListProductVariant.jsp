        ...
        <div id="wrapper">
            ...
            <div id="page-content-wrapper">
                ...
                <div class="main-content mt-5">
                    ...
                    <h2 class="text-center">Danh sách các biến thể sản phẩm </h2>
                    <div class="d-flex justify-content-between mt-3 mb-3">
                        <a href="./createProductVariant" class="btn btn-primary add-account-btn">+ Create New Product Variant</a>

                        <!-- Filter Form -->
                        <form method="GET" action="viewProductVariantList" class="d-flex mb-3">
                            <input class="me-2"
                    ...
                    <div class="container-fluid mt-4">
                        <table class="table table-bordered table-hover" id="accountTable">
                            ...
                            <tbody>
                                <c:forEach var="pv" items="${productvariants}" varStatus="status">
                                    <tr>
                                        ...
                                        <td class="table-actions">
                                            <a href="${pageContext.request.contextPath}/updateProductVariant?id=${pv.variantId}" title="Cập nhật">
                                            ...
                                            <a href="${pageContext.request.contextPath}/deleteProductVariant?id=${pv.variantId}" onclick="return confirm('Bạn có muốn xóa sản phẩm này không?')" title="Xóa">
